...
function MyTravel() {
  ...
  useEffect(() => {
    ...
    const getAllTravel = async () => {
      ...
      const resData = await axios.get(`https://travel-service-server-by-prisma-murex.vercel.app/travel/${traveller.travellerId}`)
  ...
  const handleDeleteTravelClick = async (travelId)=>{
    try{
      ...
      const response  = await axios.delete(`https://travel-service-server-by-prisma-murex.vercel.app/travel/${travelId}`)
